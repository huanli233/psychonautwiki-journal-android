    ...
    Scaffold(
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                onClick = navigateToAddCustomRecipe,
                icon = { Icon(Icons.Default.Add, contentDescription = stringResource(R.string.add_custom_recipe)) },
        ...
        Column(modifier = Modifier.padding(padding)) {
            ...
            if (filteredRecipes.isEmpty()) {
                val title = if (searchText.isEmpty()) stringResource(R.string.no_custom_recipes_yet) else stringResource(R.string.no_custom_recipes_found)
...
@Preview
@Composable
fun CustomRecipesScreenPreview() {
